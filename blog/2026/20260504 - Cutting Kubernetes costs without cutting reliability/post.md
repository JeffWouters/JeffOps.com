...
<!-- TODO(jeff): this piece has no first-person receipt in it.
     If you have run a cluster cost exercise, one paragraph of what you found
     and what it saved would carry more weight than the whole guide. If you
     have not, say so in the opening: a researched guide honestly labelled is
     defensible, an implied war story is not.
